...
{
    public abstract class ClothesBoxWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ClothesBoxWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ClothesBoxWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ClothesBoxDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ClothesBoxDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ClothesBoxDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ClothesBoxDbContext, Task<T>> func)
        {
            T result;
